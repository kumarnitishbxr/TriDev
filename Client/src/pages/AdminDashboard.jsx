...
const AdminDashboard = () => {
  ...
  {/* <DashboardNavbar/> */}
      {/* Sidebar */}
      <div className="fixed left-0 top-0 h-full w-60 bg-white shadow-lg border-r border-gray-200">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                <div className="text-center">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 hover:border-blue-400 transition-colors cursor-pointer">
                    ...
                    <p className="text-sm text-gray-500">Click to select files or drag them here</p>
                    <p className="text-xs text-gray-400 mt-1">Supports: PDF, DOC, DOCX, XLS, XLSX (Max 10MB)</p>
                  </div>
